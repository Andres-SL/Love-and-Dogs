      ...
      <section className="container w-75 bg-light mt-4 ">
        ...
        <div className="py-5 text-center">        
          ...
          {/* <div className="input-group mb-3">
            <input id="txtBuscar" type="text" className="form-control" placeholder="Buscar por nombre o id" aria-label="Buscar por nombre o id" aria-describedby="button-addon2"/>
            <button id="btnBuscar" className="btn btn-outline-secondary" type="button">Buscar</button>
          </div> */}
        </div>
        ...
        <div className="row g-5">
          <div className="col-md-7 col-lg-8">
            ...
            <form method="POST">
              ...
              <div className="row">
                <div className="col-sm-4">
                    <button type="button" className="w-100 btn btn-success btn-lg" onClick={RegistrarMascota}>Guardar</button>
                  </div>
                  <div className="col-sm-4">
